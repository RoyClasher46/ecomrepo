      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50/50 to-gray-100/50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex flex-col pt-24 md:pt-28">
        <div className="flex-grow p-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-center text-gray-900 dark:text-gray-100 mb-10">
              Your Shopping Cart
            </h1>
                  ...
                  cartItems.map((item) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2 border border-gray-300 dark:border-gray-600 rounded-lg">
                            <button
                              ...
                              className="px-3 py-1 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-l-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                              disabled={item.quantity <= 1}
                            >
                              −
                            </button>
                            <span className="px-4 py-1 text-gray-900 dark:text-gray-100 font-medium min-w-[3rem] text-center">{item.quantity}</span>
                            <button
                              onClick={async () => {
                                await fetch("/api/add-to-cart", {
                                  ...
                                  headers: { "Content-Type": "application/json" },
                                  credentials: "include",
                                  body: JSON.stringify({ productId: item._id, size: item.size || "" }),
                                });
                                await loadCart();
                                toast.success("Quantity increased");
                              }}
                              className="px-3 py-1 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-r-lg transition"
                            >
                              +
                            </button>
                          </div>
                      ...
                      <button
                        ...
                        className="text-error hover:text-error-dark transition p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg"
                      >
                        <X size={24} />
                      </button>
                    </div>
